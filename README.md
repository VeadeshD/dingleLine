...
## Project Overview
This repository contains the SystemVerilog RTL and verification testbenches for a custom FADEC architecture, targeting initial prototyping on a Lattice iCE40 FPGA, with the ultimate goal of an open-source silicon ASIC tapeout via the Efabless OpenLane flow (SkyWater 130nm PDK).
